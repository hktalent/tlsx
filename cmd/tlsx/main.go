...
func readFlags() error {
	...
	flagSet.CreateGroup("input", "Input",
		...
		flagSet.StringSliceVarP(&options.Ports, "port", "p", strings.Split(util.GetVal("TopPort"), ","), "target port to connect (default 443)", goflags.FileCommaSeparatedStringSliceOptions),
	)
